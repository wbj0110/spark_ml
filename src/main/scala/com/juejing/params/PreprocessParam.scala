package com.juejing.params

import com.juejing.conf.Conf
import com.juejing.utils.MyConf
...
/**
  ...
  *
  */
class PreprocessParam extends Conf with Serializable  {
  val kvMap: mutable.LinkedHashMap[String, String] = MyConf.loadConf("src/main/resources/preprocess.properties")
